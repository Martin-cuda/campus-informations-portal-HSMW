    ...
    <div>
      ...
      {status === "ok" && byHour && (
        <section className="card fade-up" style={{ marginTop: 16 }}>
          <h3 style={{ marginTop: 0, color: "#0f172a" }}>Visits pro Stunde – letzte 24h</h3>
      ...
      {status === "ok" && topEp && (
        <section className="card fade-up" style={{ marginTop: 16 }}>
          <h3 style={{ marginTop: 0, color: "#0f172a" }}>Top-Endpoints (24h)</h3>
                ...
                {topEp.endpoints.map((ep, i) => (
                  <tr key={ep.path + i}>
                    ...
                    <td
                      style={{
                        textAlign: "right",
                        color: ep.avg_ms > 1000 ? "#ef4444" : "#0f172a",
      ...
      {status === "ok" && recent && (
        <section className="card fade-up" style={{ marginTop: 16 }}>
          <h3 style={{ marginTop: 0, color: "#0f172a" }}>Letzte Requests</h3>
